...
public class Livre implements Comparable <Livre> {
	 ...
	 * @param utilisateur emprunteur du livre
	 * @throws BiblioException 
	 */
	public Livre (String unAuteur, String unTitre, int unNbPages, Double prix, EnumStatusLivre statut, Integer annee, Date date, Utilisateur utilisateur) throws BiblioException{
		setAuteur(unAuteur);
		setTitre(unTitre);
	...
	/**
	 * Constructeur avec sept parametres
	 * @param unAuteur auteur du livre de type string
	 * @param unTitre titre du livre de type String
	 * @param unNbPages nombre de page d'un livre de type int
	 * @param prix Prix du livre de type double
	...
	public Livre (String unAuteur, String unTitre, int unNbPages, Double prix, EnumStatusLivre statut, Integer annee, Date date) throws BiblioException{
		this(unAuteur,unTitre,unNbPages,prix,EnumStatusLivre.disponible,annee,date,null);
	...
	/**
	 * Mutateur sur l'emprunteur
	 * @param emprunteur_p l'emprunteur à affecter
	 * @throws BiblioException 
	 */
	public void setEmprunteur(Utilisateur emprunteur_p) throws BiblioException {

		
		if( emprunteur_p == null){// On rend le livre
			this.emprunteur = emprunteur_p;
			this.setDateEmprunt(null);
			//this.setStatus(EnumStatusLivre.disponible);

		}
		else {
			if( emprunteur_p != this.emprunteur){
				this.emprunteur = emprunteur_p;
				this.emprunteur.setEmprunt(this);//pour synchroniser
			}
		}
	}
