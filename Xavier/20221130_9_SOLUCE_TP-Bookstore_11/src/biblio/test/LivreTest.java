...
public class LivreTest {
	...
	public static void main(String[] args) throws ParseException {
		...
		try
		{
			livre[0] = new Livre("Victor Hugo","Les Misérables",345,9.0, EnumStatusLivre.prete,1985,Livre.sdf.parse("05-09-2011"));
		...
		System.out.println();
		System.out.println("Affichage du tableau  avant le sort");
		System.out.println();
		...
		System.out.println();
		System.out.println("Affichage du tableau  après le sort");
		System.out.println();
		for (int i=0; i < livre.length;i++)
		{
			System.out.println(livre[i]);
