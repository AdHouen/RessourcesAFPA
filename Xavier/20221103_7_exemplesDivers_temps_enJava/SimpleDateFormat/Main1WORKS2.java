...
class Main1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("PATTERN  US        FRENCH    GERMAN    ITALIAN   SWEDEN    CZECH");
        System.out.println("LETTER   EXAMPLE   EXAMPLE   EXAMPLE   EXAMPLE   EXAMPLE   EXAMPLE");
    ...
    public static void formatPattern(String pattern) {
        ...
        String us_result = sdf[0].format(date);
        System.out.print(us_result);

        sdf[1].applyPattern(pattern);
        ...
        System.out.println(sdf[1].format(date));
    }
}
