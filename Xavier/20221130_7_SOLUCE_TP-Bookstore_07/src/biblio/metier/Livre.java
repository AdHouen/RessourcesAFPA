...
public class Livre implements Comparable <Livre> {
	...
	public static SimpleDateFormat sdatef=new SimpleDateFormat("dd-MM-yyyy");
	static {sdatef.setLenient(false);}
	 ...
	 */
	public Livre (String unAuteur, String unTitre, int unNbPages, Double prix, EnumStatusLivre statut, Integer annee, Date date){
		setAuteur(unAuteur);
		setTitre(unTitre);
	 ...
	 * @param annee annee de parution du livre
	 */
	public Livre (String unAuteur, String unTitre, int unNbPages, Double prix, EnumStatusLivre statut, Integer annee) {
	 ...
	 * @param statut type enumérée statut du livre
	 */
	public Livre (String unAuteur, String unTitre, int unNbPages, Double prix, EnumStatusLivre statut) {
	...
	public String toString(){
		...
		return String.format("titre livre :%s, auteur :%s, nbPages :%d," +
				" Prix du livre :%s, Statut du livre :%s, Annee de parution du livre :%s" +
				" Date emprunt du livre :%s", this.getTitre(),this.getAuteur(),this.getNbPages(),
				decf.format(this.getPrix()),
				statutLivre,
				anneeParution.getAnnee(),
				dateEmprunt!=null?sdatef.format(dateEmprunt):"null");
/*
		if (dateEmprunt != null)
		{
			...
			if (anneeParution !=null){
				if (prix != null)
					...
					return String.format("Auteur du Livre :%s, Titre du livre :%s, Nombre de pages :%d," +
							" Prix du livre :%s, Statut du livre :%s, Annee de parution du livre :%s" +
							" Date emprunt du livre :indéterminée", this.getTitre(),this.getAuteur(),this.getNbPages(),
